...
if __name__ == "__main__":
    ...
    AOIS = [
        ...
        },
        {
            "label": "pol_1",
            "type": "auto_laser",
            "box_w": 22,  # matches BOX_W from post-process analysis
            "box_h": 22,  # matches BOX_H from post-process analysis
            "search_region": {
                ...
                "x": 250,
                "y": 0,
                "w": 900 - 250,  # SEARCH_X_MAX - SEARCH_X_MIN
                "h": 250 - 0,  # SEARCH_Y_MAX - SEARCH_Y_MIN
            },
